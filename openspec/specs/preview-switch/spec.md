# preview-switch Specification

## Purpose
TBD - created by archiving change tmux-preview-switch-key. Update Purpose after archive.
## Requirements
### Requirement: Switch to previewed pane

The TUI SHALL allow users to switch tmux to the currently previewed pane by pressing Enter. After switching, tmon SHALL remain open to allow continued monitoring and further pane switches.
...
- **AND** tmon remains open and continues monitoring
